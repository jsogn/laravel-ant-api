...
class RandomProfileHelper
{
    ...
    {
        $nicknameHead = self::nicknameHead[rand(0, count(self::nicknameHead) - 1)];
        $nicknameTail = self::nicknameTail[rand(0, count(self::nicknameTail) - 1)];

        return $nicknameHead . $nicknameTail;
    }
    ...
    {
        $nameHead = self::nameHead[rand(0, count(self::nameHead) - 1)];
        $nameTail = self::nameTail[rand(0, count(self::nameTail) - 1)];
    ...
    {
        $list = [
            'https://s1.ax1x.com/2020/07/29/aezMOe.jpg',
            'https://s1.ax1x.com/2020/07/29/aezuQO.jpg',
            'https://s1.ax1x.com/2020/07/29/aezKyD.jpg'
        ];
